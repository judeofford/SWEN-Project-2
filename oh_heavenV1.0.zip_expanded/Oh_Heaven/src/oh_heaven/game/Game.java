...
public class Game extends CardGame {
  ...
  private ArrayList<Integer> humanPlayerIndexes = new ArrayList<Integer>();
  ...
  public void setStatus(String string) { setStatusText(string); }
	...
	private void initRound() {
		    ...
		    for(int i=0;i<humanPlayerIndexes.size();i++) {
		    	players.get(humanPlayerIndexes.get(i)).setListener(hands[humanPlayerIndexes.get(i)]);
			}
			 // graphics
	...
	public void startGame(Properties properties) {
		...
		for (int i = 0; i < nbPlayers; i++) {
			...
			BasePlayer newPlayer = PlayerCreator.createPlayer(type);
